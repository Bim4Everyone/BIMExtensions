...
def reload_existing_links(selected_files, progress, cancellation_token):
    ...
    link_files = [(link_file, link_file.GetParamValue(BuiltInParameter.ALL_MODEL_TYPE_NAME)) for link_file in
                  linked_files]
...
def script_execute(plugin_logger):
    selected_files = forms.pick_file(files_filter="Revit files (*.rvt)|*.rvt", multi_file=True,
